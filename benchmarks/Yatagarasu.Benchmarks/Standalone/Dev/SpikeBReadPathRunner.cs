...
//   if (args[0] == "--spike-b") return Yatagarasu.Benchmarks.Standalone.Dev.SpikeBReadPathRunner.Run();
...
///
/// 起動: <c>dotnet run --project benchmarks/Yatagarasu.Benchmarks -c Release -- --spike-b</c>
/// </summary>
