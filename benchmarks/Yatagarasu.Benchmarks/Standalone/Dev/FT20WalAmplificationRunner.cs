...
//   if (args[0] == "--ft20-wal") return Yatagarasu.Benchmarks.Standalone.Dev.FT20WalAmplificationRunner.Run();
...
///
/// 起動方法: <c>dotnet run --project benchmarks/Yatagarasu.Benchmarks -- --ft20-wal</c>
