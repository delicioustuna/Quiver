...
public class WeightedAdjBenchmarks
{
    ...
    private YatagarasuDatabase _v2Db = null!;
    private YatagarasuDatabase _v1Db = null!;
    ...
    public void Setup()
    {
        ...
        {
            using var db = YatagarasuDatabase.Open(System.IO.Path.Combine(_v2Path, "graph.yata"));
        ...
        _v2Db = YatagarasuDatabase.Open(System.IO.Path.Combine(_v2Path, "graph.yata"));
        ...
        {
            using var db = YatagarasuDatabase.Open(System.IO.Path.Combine(_v1Path, "graph.yata"));
        ...
        _v1Db = YatagarasuDatabase.Open(System.IO.Path.Combine(_v1Path, "graph.yata"));
