...
/// <summary>TS-6 sentinel: <see cref="KnnNodeSourceOperator"/> top-K=10 over 100 vectors dim=16.</summary>
[MemoryDiagnoser]
[ShortRunJob]
public class KnnNodeSourceOperatorBench
{
    ...
    public int Knn_k10()
    {
        using var op = new KnnNodeSourceOperator(IndexName, _query, k: 10);
