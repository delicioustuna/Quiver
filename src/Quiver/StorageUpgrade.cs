...
public sealed class StorageUpgradeOptions
{
    ...
    /// Quiver が名前を割り当てる。原子的な切替のため source と同じディレクトリでなければならない。
    /// </summary>
...
/// <param name="TargetVersion">この Quiver build が使用する QUIVER-SW family version。</param>
...
/// </summary>
public sealed class StorageUpgradeNotSupportedException : QuiverException
{
