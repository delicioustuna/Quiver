...
{
    private const string NexusAttributeFqn = "Yatagarasu.Api.NexusAttribute";
    private const string RoleAttributeFqn = "Yatagarasu.Api.RoleAttribute";
    private const string PropertyAttributeFqn = "Yatagarasu.Api.PropertyAttribute";
    private const string GraphVertexRefName = "GraphVertexRef";
    private const string GraphVertexRefNamespace = "Yatagarasu.Api";
