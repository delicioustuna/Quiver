...
/// </summary>
/// <typeparam name="TSource">始点ノード型 (<c>[GraphNode]</c> 付きクラス)。</typeparam>
/// <typeparam name="TTarget">終点ノード型 (<c>[GraphNode]</c> 付きクラス)。</typeparam>
/// <remarks>
...
public sealed class GraphRelationshipAttribute<TSource, TTarget> : Attribute
{
