...
internal sealed class PhysicalOperatorCursor : IQueryCursor
{
    ...
    private readonly Yatagarasu.Storage.Records.IVertexStore _vertices;
    private readonly Yatagarasu.Storage.Records.IEdgeStore _edges;
    private readonly Yatagarasu.Storage.Records.INexusStore _nexuses;
    ...
    internal PhysicalOperatorCursor(
        ...
        Yatagarasu.Storage.Records.IVertexStore vertices,
        Yatagarasu.Storage.Records.IEdgeStore edges,
        Yatagarasu.Storage.Records.INexusStore nexuses,
