...
namespace Yatagarasu.Query.Logical;
...
/// <summary>融合戦略。現在は RRF (Reciprocal Rank Fusion) のみ。enum は将来拡張用。</summary>
...
/// (現在は RRF) で融合し上位 <see cref="K"/> 件を放出する。RRF は rank のみで計算できるため
