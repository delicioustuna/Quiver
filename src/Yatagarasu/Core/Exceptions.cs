...
/// <summary>Yatagarasu が投げる全例外の基底型。</summary>
public abstract class YatagarasuException : Exception
{
    /// <summary>メッセージを指定して例外を生成する。</summary>
    /// <param name="message">エラーメッセージ。</param>
    protected YatagarasuException(string message) : base(message) { }
    /// <summary>メッセージと内部例外を指定して例外を生成する。</summary>
    /// <param name="message">エラーメッセージ。</param>
    /// <param name="inner">原因となった内部例外。</param>
    protected YatagarasuException(string message, Exception inner) : base(message, inner) { }
}
...
public sealed class StorageException(string message, Exception? inner = null)
    : YatagarasuException(message, inner!);
...
public sealed class WriterBusyException : YatagarasuException
{
...
public sealed class ConcurrentTransactionUseException : YatagarasuException
{
...
/// </summary>
public sealed class TransactionTooLargeException : YatagarasuException
{
