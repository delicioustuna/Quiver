...
/// </summary>
/// <remarks>
/// 各マイグレーションは <see cref="YatagarasuDatabase.MigrateAsync"/> に渡され、未適用のものだけが
...
/// 注意: ラベル、プロパティキー、索引のリネームはtoken catalogと索引ファイルの物理操作であり、
/// データミューテーションと違ってトランザクション境界では巻き戻らない。
...
internal interface IMigration
{
    ...
    /// (Yatagarasu 自体は revert を自動実行しない。運用者が手動で呼ぶ場合の置き場)。
    /// </summary>
