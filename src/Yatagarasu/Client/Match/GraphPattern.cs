...
public sealed class VertexPattern
{
    ...
    public GraphPattern Out<TEdge>(VertexPattern end) where TEdge : global::Yatagarasu.IGraphEdgeEntity<TEdge>
    ...
    public GraphPattern In<TEdge>(VertexPattern end) where TEdge : global::Yatagarasu.IGraphEdgeEntity<TEdge>
