...
public sealed class NexusTransactionTests : IDisposable
{
    ...
    private readonly string _containerPath = Path.Combine(Path.GetTempPath(), Path.GetRandomFileName() + ".yata");
    private readonly string _crashPath = Path.Combine(Path.GetTempPath(), Path.GetRandomFileName() + ".yata");
    ...
    {
        string srcPath = Path.Combine(Path.GetTempPath(), Path.GetRandomFileName() + ".yata");
        string crashPath = Path.Combine(Path.GetTempPath(), Path.GetRandomFileName() + ".yata");
