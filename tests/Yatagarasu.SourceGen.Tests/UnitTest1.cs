...
public class GraphVertexGeneratorTests
{
    ...
    {
        var attributeRef = typeof(Yatagarasu.Api.VertexAttribute).Assembly.Location;
        var engineRef    = typeof(Yatagarasu.IWriteTransaction).Assembly.Location;
        ...
        generatedSource.Should().Contain("public static Yatagarasu.Core.VertexId Insert(");
        generatedSource.Should().Contain("public static Person Load(");
        generatedSource.Should().Contain("public static void Update(");
        generatedSource.Should().Contain("public static Yatagarasu.VertexGraphRewriteResult Replace(");
    ...
    public void Generator_emits_unique_scalar_index_definition()
    {
        ...
        generatedSource.Should().Contain(
            "new Yatagarasu.ScalarIndexDefinition(\"person_name\", new Yatagarasu.PropertyTarget(Yatagarasu.PropertyOwnerKind.Vertex, \"Name\", \"Person\"), Yatagarasu.IndexKind.StringEquality, true)");
    }
...
public class GraphEdgeGeneratorTests
{
    ...
    {
        var attributeRef = typeof(Yatagarasu.Api.EdgeAttribute<,>).Assembly.Location;
        var engineRef    = typeof(Yatagarasu.IWriteTransaction).Assembly.Location;
        ...
        generatedSource.Should().Contain("public static Yatagarasu.Core.EdgeId Insert(");
        generatedSource.Should().Contain("tx.CreateEdge(from, to, \"KNOWS\")");
        generatedSource.Should().Contain("public static Knows Load(");
        generatedSource.Should().Contain("public static void Update(");
        generatedSource.Should().Contain("public static Yatagarasu.EdgeReplacement Replace(");
