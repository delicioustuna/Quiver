...
public sealed class GraphStoreContractTests
{
    ...
    public void Adopted_query_surface_supports_traversal_typed_predicates_and_match()
    {
        ...
        {
            var pattern = Yatagarasu.Api.Match.GraphPattern.Vertex("a", "WorkspacePerson")
                .Out("KNOWS", Yatagarasu.Api.Match.GraphPattern.Vertex("b", "WorkspacePerson"));
...
[Yatagarasu.Api.Vertex("WorkspacePerson")]
internal partial class WorkspacePerson
{
    [Yatagarasu.Api.Property]
