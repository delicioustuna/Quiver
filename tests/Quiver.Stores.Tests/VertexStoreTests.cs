...
public class VertexStoreTests : IDisposable
{
    ...
    public VertexStoreTests()
    {
        _pf = new PagedFile(_path);
        _store = new VertexStore(_pf);
    }
    ...
    [Fact]
    public void Write_persists_first_edge()
    {
        var id = _store.Allocate(new LabelId(1));
        {
    ...
    [Fact]
    public void Scan_returns_only_in_use_vertices()
    {
