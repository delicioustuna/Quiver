...
public class GraphRelationshipGeneratorTests
{
    ...
    {
        var attributeRef = typeof(GraphDb.Engine.Client.GraphRelationshipAttribute).Assembly.Location;
        var engineRef    = typeof(GraphDb.Engine.IGraphTransaction).Assembly.Location;
        ...
        generatedSource.Should().Contain("public static GraphDb.Engine.Core.RelationshipId Insert(");
