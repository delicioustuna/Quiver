...
public sealed class MigrationTests : IDisposable
{
    ...
    {
        _dir = Path.Combine(Path.GetTempPath(), "yatagarasu_migration_" + Guid.NewGuid().ToString("N"));
    }
    ...
    {
        var path = System.IO.Path.Combine(_dir, "graph.yata");
    ...
    private static LabelId ResolveLabel(YatagarasuDatabase database, string name)
    {
