...
| HYP-7 | docs/spec as-built 追記 + development.md + サンプル (RAG n 項ファクト) | HYP-4, HYP-5, HYP-6 | 完 (2026-07-07)。spec 3 本 + V4 表記統一 + development.md + `Quiver.Samples.Hyperedges` (三 API 読み戻し + 出典 Chunk 回収) + 用語集。**HYP トラック全タスク完了** |
