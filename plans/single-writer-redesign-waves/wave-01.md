...
- [ ] 正本 §2.3、§5.1、§8.1、§15、§16 と review C-7 の `LabelNodeIndex.Lookup` full ID、Wave 7 で削除する内部物理ブリッジ、primary `Read` 検証直後の `Sequence`、互換性を保証する public contract ではない規則が一致する。
