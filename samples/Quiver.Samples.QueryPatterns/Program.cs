...
try
{
    ...
    using (var tx = db.BeginTransaction())
    {
        ...
        var alice = g.Insert(new Person { Name = "Alice", Age = 30 });
        var bob   = g.Insert(new Person { Name = "Bob",   Age = 25 });
        var carol = g.Insert(new Person { Name = "Carol", Age = 35 });
        var dave  = g.Insert(new Person { Name = "Dave",  Age = 28 });

        var cutter   = g.Insert(new Tool { Name = "Cutter" });
        var compiler = g.Insert(new Tool { Name = "Compiler" });
        var drill    = g.Insert(new Tool { Name = "Drill" });
