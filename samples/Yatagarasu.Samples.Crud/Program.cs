// Yatagarasu.Samples.Crud — 基本 CRUD: Vertex作成、プロパティ設定、リレーション作成、削除。
//
// 実行: dotnet run --project samples/Yatagarasu.Samples.Crud

using Yatagarasu;
using Yatagarasu.Storage.Records;

string dir = Path.Combine(Path.GetTempPath(), "yatagarasu_crud_" + Guid.NewGuid().ToString("N")[..8]);
try
{
