// Yatagarasu.Samples.Hosting — ASP.NET Core minimal API から Yatagarasu を DI 経由で利用するサンプル。
//
// 実行: dotnet run --project samples/Yatagarasu.Samples.Hosting
//
// 設定オーバーライド例 (環境変数):
//   set Yatagarasu__DataDirectory=C:\data\yatagarasu
//   set Yatagarasu__BufferPoolSize=536870912
...
{
    service = "Yatagarasu Hosting Sample",
    endpoints = new[]
    {
...
// Yatagarasu.Hosting.Tests から WebApplicationFactory<Program> で起動するために
