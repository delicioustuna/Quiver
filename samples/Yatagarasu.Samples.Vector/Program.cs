// Yatagarasu.Samples.Vector — KNN を起点とするトラバーサルと graph-first ハイブリッド検索。
//
// 実行: dotnet run --project samples/Yatagarasu.Samples.Vector

using Yatagarasu;
using Yatagarasu.Api;
using Yatagarasu.Core;

string dir = Path.Combine(Path.GetTempPath(), "yatagarasu_vec_" + Guid.NewGuid().ToString("N")[..8]);
try
{
