// Yatagarasu.Samples.Match — Match DSL + MERGE。
//
// 実行: dotnet run --project samples/Yatagarasu.Samples.Match
...
string dir = Path.Combine(Path.GetTempPath(), "yatagarasu_match_" + Guid.NewGuid().ToString("N")[..8]);
try
{
