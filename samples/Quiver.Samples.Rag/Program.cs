...
try
{
    ...
    var docs = new[]
    {
        new IngestedDocument("guide/quiver", "Quiver 入門",
            new Dictionary<string, string> { ["category"] = "guide" },
            new[]
            {
                new IngestedBlock(BlockKind.Heading, "概要", HeadingLevel: 1),
                new IngestedBlock(BlockKind.Paragraph, "Quiver はグラフとベクトルと全文検索の組込エンジン"),
        ...
        new IngestedDocument("guide/rag", "RAG バックエンド",
            ...
            new[]
            {
                ...
                new IngestedBlock(BlockKind.Paragraph, "Quiver は隣接チャンクを辿り周辺文脈を返せる"),
            }),
    };
